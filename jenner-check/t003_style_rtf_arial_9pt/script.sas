/**************************************************************************
 Program:  Style_rtf_arial_9pt.sas  (compatibility bundle)
 Library:  General
 ...
 Adapted from Prog/Style_rtf_arial_9pt.sas: the leading %include of the
 site StdLocal.sas is dropped (it only sets library paths); the PROC
 TEMPLATE style definition below is verbatim from the repository.
**************************************************************************/
