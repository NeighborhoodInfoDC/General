/**************************************************************************
 Program:  Style_rtf_lato_8pt.sas
 Library:  General
...
proc template;
  define style Styles.Rtf_lato_8pt;
    parent=styles.rtf;
       ...
       replace fonts /
        ...
        'docFont' = ("lato",8pt)
        /** Heading fonts **/
        'headingEmphasisFont' = ("lato",8pt,Bold Italic)
        'headingFont' = ("lato",8pt,Bold)
        'StrongFont' = ("lato",8pt,Bold)
        'EmphasisFont' = ("lato",8pt,Italic)
