...
* Environment:  Windows
* 
* Description:  Create Census 2000 block to Ward (2002) file 
...
data General.Block00_Ward02 
  ...
  ** Remove silly formats/informats, unneeded variables **;
  ...
  keep Geo2000 GeoBlk2000 Ward2002 CJRTRACTBL Gis_id NAME x y;
...
proc sort data=General.Block00_Ward02 nodupkey;
  by GeoBlk2000;

%File_info( data=General.Block00_Ward02, stats=, freqvars=Ward2002 )
...
%Data_to_format(
  ...
  Label=Ward2002,
  OtherLabel="",
  Desc="Block 2000 to Ward 2002 correspondence",
  Print=N,
  Contents=Y
  )
