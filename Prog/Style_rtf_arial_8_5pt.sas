/**************************************************************************
 Program:  Style_Rtf_arial_8_5pt.sas
 Library:  General
...
proc template;
  define style Styles.Rtf_arial_8_5pt;
    parent=styles.rtf;
       ...
       replace fonts /
        ...
        'docFont' = ("Arial",8.5pt)
        /** Heading fonts **/
        'headingEmphasisFont' = ("Arial",8.5pt,Bold Italic)
        'headingFont' = ("Arial",8.5pt,Bold)
        'StrongFont' = ("Arial",8.5pt,Bold)
        'EmphasisFont' = ("Arial",8.5pt,Italic)
