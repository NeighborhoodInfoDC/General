...
%Calc_weights_from_blocks( 
  ...
  geo2 = NPA2019, /*converting to this geo*/
  out_ds = Wt_tr00_npa19, /*data set being created*/
  block_corr_ds = General.Block00_NPA19, /*created this correspondence in the previous set*/
  block = GeoBlk2000,         
