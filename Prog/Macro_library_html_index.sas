...
column program_srt program macro description;
...
%let _macro_library_path = %mif_select( &_remote_batch_submit, &_dcdata_default_path\SAS\Macros, &_dcdata_l_drive:\DCData\SAS\Macros );

%CodeIndex( 
path=&_dcdata_default_path\General\Macros,
htmpath=&_dcdata_default_path\General\Macros\Html,
htmtitle="General Library Macros - Urban-Greater DC",
htmstyle=Solutions,
